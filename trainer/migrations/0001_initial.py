# Generated by Django 5.0.1 on 2024-02-17 20:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='primary_bodyparts', through='trainer.ExercisePrimaryBodypart', to='trainer.bodypart'),
        ),
        migrations.CreateModel(
            name='ExerciseSecondaryBodypart',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('exercise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trainer.exercise')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='secondary_bodyparts', through='trainer.ExerciseSecondaryBodypart', to='trainer.bodypart'),
        ),
        migrations.CreateModel(
